...
import jarduboy.core.ControlPad;
 ...
 *
 */
public class ArduboyPeripheral extends JPeripheral {
	private final ArduboyEmulator tinyBoy;

	public ArduboyPeripheral(ArduboyEmulator tinyBoy) {
		super("TinyBoy");
